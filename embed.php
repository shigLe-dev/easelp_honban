    ...
    <body>
        ...
        <div id="chat_area">
            ...
            <div style="margin-top:6vh;">
                ...
                <a class="menu_box" href="./embed_search.php?u=<?php echo($user_name); ?>">
                    Search
                    </a>
                        
                <a class="menu_box" href="./embed_menu.php?u=<?php echo($user_name) ?>">
                    Question/Discussion
                    </a>
            ...
            <div id="chat_main">
                <div class="chat_text bot">
                    Hello,Do you have any questions about <?php 
                    //ユーザー名を表示
                    if($user_found == true){
                        echo($user_name);
                        } ?>?
